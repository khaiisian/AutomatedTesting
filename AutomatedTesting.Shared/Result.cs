namespace AutomatedTesting.Shared;
...
public class Result<T>
{
    ...
    {
        get { return Type == EnumRespType.InvalidData; }
    }
    ...
    public static Result<T> Error(string message = "Some ErrorOccured", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.Error };
    public static Result<T> DuplicateRecordError(string message = "DuplicateRecord Error Occured", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.DuplicateRecord };
    public static Result<T> NotFoundError(string message = "NotFound Error Occured", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.NotFound };
    public static Result<T> InvalidDataError(string message = "InvalidData Error Occured", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.InvalidData };
    public static Result<T> BadRequestError(string message = "User Input Error", T? data = default) => new Result<T> { IsSuccess = false, Data = data, Message = message, Type = EnumRespType.BadRequest };
